...
/* Start Menu */
    ...
    /* submenu border color */
        ...
        div.wp-custom-menu-popup,
        #nav ul
        { border-color: #<?php echo Mage::helper("ExtraConfig")->themeOptions('submenu_border_color') ?>; }
    ...
    /* shopping font */
        ...
        { color: #<?php echo Mage::helper("ExtraConfig")->themeOptions('shoppingcart_font_color') ?>; }
    /* End shopping font */
    ...
    /* End Menuwidth */
                ...
                <?php
                $hex1 =  "#".Mage::helper("ExtraConfig")->themeOptions('shadow_color'); 
                $val1 = html2rgb($hex1);
                ?>
    
    
    /* Top Menu shadow width and color */
        <?php $shadowwidth = Mage::helper("ExtraConfig")->themeOptions('shadow_width'); ?>
        <?php $shadowcolor = Mage::helper("ExtraConfig")->themeOptions('shadow_color'); ?>
        <?php if (isset($shadowwidth) && $shadowwidth != null){
          $shadowwidth1 = $shadowwidth;  
        } else { 
            $shadowwidth1  =  '0px 0px 1px 0px';   
        } ?>
        
        <?php if (isset($shadowcolor) && $shadowcolor != null){
            $color = 'rgba('.$val1[0].','. $val1[1].','. $val1[2].', 0.25)';
          $shadowcolor2 = $color;  
            } else { 
            $shadowcolor2  =  "rgba(0, 0, 0, 0.25)";   
        } ?>
        
        .menu-contain{box-shadow: <?php echo $shadowwidth1 . ' ' . $shadowcolor2 ?>;}
    /* Top Menu shadow width and color*/
    
    /* Top Menu shadow */
        <?php $shadow = Mage::helper("ExtraConfig")->themeOptions('shadow'); ?>
        <?php if($shadow == '0') { ?>
    ...
    /* Menu shadow */
        <?php $submenu_shadow = Mage::helper("ExtraConfig")->themeOptions('submenu_shadow'); ?>
        <?php if($submenu_shadow == '0') { ?>
            div.wp-custom-menu-popup,
            #nav  ul
            {box-shadow: none;}
        <?php } ?>
...
/* Breadcrumbcolor */
    .breadcrumbs
    { background-color:#<?php echo Mage::helper("ExtraConfig")->themeOptions('breadcrumb_color') ?>;}
/* Breadcrumbcolor */
